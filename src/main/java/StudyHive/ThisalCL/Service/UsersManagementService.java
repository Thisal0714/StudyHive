package StudyHive.ThisalCL.Service;

import StudyHive.ThisalCL.Dto.ReqRes;
import StudyHive.ThisalCL.Entity.User;
import StudyHive.ThisalCL.Repositories.UserRepository;
    ...
    public ReqRes register(ReqRes registrationRequest){
        ...
        try {
            ...
            if (existingUser.isPresent()) {
                ...
                resp.setMessage("Email already exists. Try another email.");
                return resp;
            }
